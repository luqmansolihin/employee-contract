        ...
        <div class="p-6 sm:p-8 rounded-2xl bg-white border border-[#E2E8F0] shadow-xs">
            ...
            <form action="{{ route('offering-letters.update', $offeringLetter) }}" method="POST" class="space-y-6"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="offer_date" class="block text-xs font-bold text-[#1C2434] mb-1">Tanggal
                            Penawaran</label>
                    ...
                    <div>
                        <label for="proposed_start_date" class="block text-xs font-bold text-[#1C2434] mb-1">Tanggal
                            Mulai</label>
                    ...
                    <div>
                        <label for="proposed_end_date" class="block text-xs font-bold text-[#1C2434] mb-1">Tanggal
                            Selesai</label>
                    ...
                    <div>
                        <label for="basic_salary" class="block text-xs font-bold text-[#1C2434] mb-1">Gaji Pokok / Saku
                            (Rp)</label>
                    ...
                    <div class="sm:col-span-2">
                        <label for="valid_until" class="block text-xs font-bold text-[#1C2434] mb-1">Berlaku Hingga (Batas
                            Konfirmasi)</label>
                    ...
                    <div class="sm:col-span-2">
                        <label for="terms" class="block text-xs font-bold text-[#1C2434] mb-1">Syarat &
                            Ketentuan</label>
                        <textarea name="terms" id="terms" rows="3"
                            class="w-full px-3.5 py-2 text-xs rounded-xl bg-[#F8FAFC] border border-[#E2E8F0] focus:bg-white focus:border-[#3C50E0] outline-hidden transition">{{ old('terms', $offeringLetter->terms) }}</textarea>
                    </div>
