                        ...
                        <div id="selected_employee_card"
                            ...
                            <div class="flex items-start justify-between gap-3 pb-3 border-b border-slate-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h5 class="text-sm font-bold text-[#1C2434]" id="detail_emp_name">{{ $offeringLetter->employee->name }}</h5>
                                        <p class="text-xs text-slate-500 font-mono" id="detail_emp_ktp">NIK: {{ $offeringLetter->employee->ktp_number }}</p>
                                    </div>
                                </div>
                                <span
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-3 text-xs">
                                <div>
                                    <span class="text-slate-400 block text-[10px] uppercase font-semibold">Posisi /
                                        Jabatan</span>
                                    <span class="font-bold text-slate-700" id="detail_emp_position">{{ $offeringLetter->employee->current_position ?: '-' }}</span>
                                </div>
                                <div>
                                    <span class="text-slate-400 block text-[10px] uppercase font-semibold">Cabang /
                                        Lokasi</span>
                                    <span class="font-bold text-slate-700" id="detail_emp_branch">{{ $offeringLetter->employee->current_branch ?: '-' }}</span>
                                </div>
                                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="letter_number" id="letter_number"
                                ...
                                value="{{ $displayLetterNumber }}" required
                                autocomplete="off"
